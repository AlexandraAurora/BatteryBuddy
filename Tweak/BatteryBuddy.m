...
void _UIBatteryView_refreshIcon(_UIBatteryView* self, SEL _cmd) {
	...
	if (![self batteryBuddyStatusBarChargerImageView] && isCharging) {
		...
		[[self batteryBuddyStatusBarChargerImageView] setImage:[UIImage imageWithContentsOfFile:[kDocumentPath stringByAppendingString:@"/StatusBarCharger.png"]]];
...
void override_CSBatteryFillView_didMoveToWindow(CSBatteryFillView* self, SEL _cmd) {
	...
	if (![self batteryBuddyLockScreenIconImageView]) {
		...
		[[self batteryBuddyLockScreenIconImageView] setImage:[UIImage imageWithContentsOfFile:[kDocumentPath stringByAppendingString:@"/LockScreenHappy.png"]]];
	}
	...
	if (![self batteryBuddyLockScreenChargerImageView]) {
		...
		[[self batteryBuddyLockScreenChargerImageView] setImage:[UIImage imageWithContentsOfFile:[kDocumentPath stringByAppendingString:@"/LockScreenCharger.png"]]];
	}
